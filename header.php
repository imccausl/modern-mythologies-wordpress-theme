...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'mmwordpresstheme' ); ?></a>
    ...
    <div class="site-branding">
        ...
        <span class="element-highlight"><?php the_custom_logo(); ?></span>

    </div><!-- .site-branding -->
		<nav id="site-navigation" class="main-navigation" role="navigation">
      
			  <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'mmwordpresstheme' ); ?></button>
